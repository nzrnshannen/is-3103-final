                            ...
                            <div class="app-showcase__inner">
                                ...
                                <div class="btn-sowcase">
                                    <div class="button-group-wrap">
                                        <a href="#" class="image-btn img-fluid me-2">
                                            <img src="../../assets/img/icons/aeroland-black-button-google-play.jpg" alt="thumbnail">
                                        </a>
                                        <a href="#" class="image-btn img-fluid">
                                            <img src="../../assets/img/icons/aeroland-button-app-store-dark.jpg" alt="thumbnail">
                                        </a>
                                    </div>
                                </div>
                            </div>
