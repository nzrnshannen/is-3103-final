                ...
                <div class="pricing-table__top">
                    <div class="pricing-table__header">
                        <div class="pricing-table__image">
                            <img src="../assets/img/article1.png" class="img-fluid" alt="">
                        </div>
                        <h5 class="pricing-table__title">Book online; medical consultation with CFI doctor and issuance of letter of authority(LOA)</h5>
                    </div>
                    <div class="pricing-table__body">
                        <p class="pricing-table__list text-center">Skip waiting and expect the same quality health care services as you conveniently book online your medical consultation with the CFI doctor and request for issuance of a letter of authority.</p>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-4 pricing-table pricing-table--popular wow move-up">
            <div class="pricing-table__inner">
                <div class="pricing-table__top">
                    <div class="pricing-table__header">
                        <div class="pricing-table__image">
                            <img src="../assets/img/article2.png" class="img-fluid" alt="">
                        </div>
                        <h5 class="pricing-table__title">Plant Festival Queen 2022 Mutya ng Mayana visits CFI before the coronation night</h5>
                    </div>
                    <div class="pricing-table__body">
                        <p class="pricing-table__list text-center">Plant Festival Queen 2022 Mutya ng Mayana visits CFI before the coronation night. Read more about this issue.</p>
                        <!-- <ul class="pricing-table__list text-center">
                            <li>03 projects</li>
                            <li>Power And Predictive Dialing </li>
                            <li>Quality &amp; Customer Experience</li>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-4 pricing-table pricing-table--popular wow move-up">
            <div class="pricing-table__inner">
                <div class="pricing-table__top">
                    <div class="pricing-table__header">
                        <div class="pricing-table__image">
                            <img src="../assets/img/article3.png" class="img-fluid" alt="">
                        </div>
                        <h5 class="pricing-table__title">CFI Online app is now available for download on Apple Store and Google play store!</h5>
                    </div>
                    <div class="pricing-table__body">
                        <p class="pricing-table__list text-center">Finally, the CFI Online is now up for download on App Store for IOS and Google Play store for Android. Get ready to stay on top of your CFI account right at your fingertips.</p>
                        <!-- <ul class="pricing-table__list text-center">
                            <li>03 projects</li>
                            <li>Power And Predictive Dialing </li>
                            <li>Quality &amp; Customer Experience</li>
