            ...
            <nav class="navbar navbar-expand-lg" id="navbar-example2">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                    <ul class="nav main-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#product" @click="menuCollapseOnLinkClick">
                                <span>product</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#testimonial" @click="menuCollapseOnLinkClick">
                                <span>testimonial</span>
                            </a>
                        </li>
                    </ul>
                </div>
                <div class="header-button button--white d-none d-xl-block btn-group">
